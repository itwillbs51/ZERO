...
<body>
	...
	<article id="mainArticle">
		...
		<!-- 							<input class="datepicker" placeholder="정산을 확인하고 싶은 날짜" data-v-32a5de90=""> | -->
					...
					<div id="map" style="width:600px;height:350px;" data-v-32a5de90=""></div>
			...
			// 				});
							...
							// 지도에 마커를 생성하고 표시한다
			// 				var marker = new kakao.maps.Marker({
			// 				    position: new kakao.maps.LatLng(37.56712, 126.97729), // 마커의 좌표
			...
			// 				var circle = new kakao.maps.Circle({
			// 					map: map, // 원을 표시할 지도 객체
			// 					center : new kakao.maps.LatLng(37.56892, 126.96901), // 지도의 중심 좌표
