			...
			<main>
				<div class="container-fluid px-4">
					...
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item active">자주 묻는 질문 작성</li>
					</ol>
					...
					<%-- main 내용 작성 영역 --%>
						...
						<div class="card-body">		
							<%-- main 내용 작성 영역 --%>
							<form action="admin_cs_faq_write_pro" id="cs_form" method="post" enctype="multipart/form-data">
								<input type="hidden" name="cs_type" value="자주묻는질문" ><%-- 공지사항 유형 정보 전송용 --%>						
								...
								<tbody>
								    ...
								    <tr>
								    	<td scope="col" class="align-middle" width="100">분류</th>
								    	<td>
							    			<select name="cs_info_idx" required="required">
												...
												<option value="4">중고구매</option>
												<option value="5">경매판매</option>
												<option value="6">경매구매</option>
												<option value="7">ZPAY</option>
											</select>
								    	</td>
								    </tr>
									<tr>
									      ...
									      <td scope="col" class="align-middle">
									      		<textarea class="form-control" rows="10" cols="200" name="cs_content" id="cs_content"></textarea>
									      </td>
								    </tr>
									<tr>
